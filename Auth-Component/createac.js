...
<div class="test_cases_password">
   ...
   <li>Between 8 and 20 characters</li> 
    ...
    <li>Contains a capital & lowercase letter</li>
...
<div class="bottom-country">
    <div><input type="checkbox" id="check2" value="yes"> <span class="rememberMe">Rememeber me</span></div>
</div>
<div class="sign-up-btn">   <input type="submit"class="sign-up-input-btn"   value="CREATE AN ACCOUNT"></div>
...
<hr class="sign-In">
<div class="signIninSignUp"><span>Already have an account?</span>&nbsp;<span class="signuplinkbtn">Sign In now</span></div>
</form>`
