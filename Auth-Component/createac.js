export default ()=>{
    ...
    return `  <span class="cross2">&times;</span>
    <form class="form-SignUp" >
     <div><p>Sign Up</p></div>
     <div class="emaildiv">   <input type="email" class="field signupemail" required>
      <label for="email" class="email_label signupemail">Email Address*</label>
    
     </div>
     <div class="password">
        <div class="password-field"><input class="field field2 showSignupPass" type="password"  required></div>
        <div class="eye-image-div"> <img class="eye2" src="https://img.icons8.com/ios/512/visible--v1.png"></div>  
         <label for="password" class="password_label">Password*</label>
    </div>
    <div class="test_cases_password">
        <ul>
       <li id="length"><span class='tc1'>&#9747;</span>Between 8 and 20 characters</li> 
       <li id="number"><span class='tc2'>&#9747;</span>At least one number</li> 
       <li id="captial_and_lower"><span class='tc3'>&#9747;</span>Contains a capital & lowercase letter</li> 
       <li id="restrictions"><span class='tc4'>&#9747;</span>Cannot contain < > & </li> 
    ...
    <div>
        ...
        <label for="country" class="selectcountryLabel">Country*</label>
    </div>
    <div class="bottom-country">
        <div><input type="checkbox" id="check2" value='false'> <span class="rememberMe">Rememeber me</span></div>
    </div>
